...
public class FavouriteRecipeAdapter extends RecyclerView.Adapter<FavouriteRecipeAdapter.Recipe2ViewHolder> {
    private List<Recipe> recipes;

    public FavouriteRecipeAdapter(List<Recipe> recipes) {
